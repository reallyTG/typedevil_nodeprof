...
(function (sandbox) {
    ...
    function MyAnalysis() {
        ...
        this.declare = function (iid, name, val, isArgument, argumentIndex, isCatchParam) {
            console.log(`In SMemory::declare for name: ${name}`);
            smemory.initialize(name);
        };

        // moved
        this.invokeFunPre = function (iid, f, dis, args) {
            console.log(`In SMemory::invokeFunPre for ${f.name} at ${J$.iidToLocation(iid)}`);
        ...
        this.invokeFun = function (iid, returnVal, wrappedExceptionVal) {
            console.log(`In SMemory::invokefun at ${J$.iidToLocation(iid)}`);
        ...
        this.endExecution = function () {
            this.scriptExit(69420, null);
        }

        this.scriptEnter(69420, "file.js", "ofile.js"); // lol

    }

    console.log("Entering SMemory...");

    sandbox.analysis = new MyAnalysis();

    console.log("Leaving SMemory...");
